...
class Service_request(db.Model):
    ...
    date_of_completion = db.Column(db.DateTime, default = datetime.now) # NEED TO CONFIRM on type
...
class Service(db.Model):
    ...
    description = db.Column(db.String, nullable = False)
    sp = db.relationship('Service_professional', backref = 'service', lazy = True)
    sr = db.relationship('Service_request', backref = 'service', lazy = True)